...
article_types = {u'development language': ['Python', 'Java', 'JavaScript'],
                 'Linux': [u'Linux Road to growth', u'Linux operation', 'CentOS', 'Ubuntu'],
                 u'network technique': [u'Cisco networking', u'Other'],
                 u'database': ['MySQL', 'Redis'],
                 u'Love life, love yourself': [u'Those things in life', u'Those things in school',u'Those feelings'],
...
class Menu(db.Model):
    ...
    @staticmethod
    def insert_menus():
        menus = [u'Web development', u'database', u'network technique', u'Love life, love yourself',
                 u'Linux world', u'development language']
        for name in menus:
            menu = Menu(name=name)
            db.session.add(menu)
            db.session.commit()
    ...
    def return_menus():
        ...
        menus.append((-1, u'Navigation is not selected (the classification will be separated into one navigation)'))
        return menus
...
class ArticleType(db.Model):
    ...
    def insert_system_articleType():
        articleType = ArticleType(name=u'Unclassified',
                                  introduction=u'System default classification, can not be deleted.',
    ...
    def insert_articleTypes():
        articleTypes = ['Python', 'Java', 'JavaScript', 'Django',
                        ...
                        u'Linux Road to growth', u'Linux operation', u'Other',
                        u'Cisco networking', u'Those things in life', u'Those things in school',
                        u'Those feelings', 'Flask']
...
class BlogInfo(db.Model):
    ...
    def insert_blog_info():
        blog_mini_info = BlogInfo(title=u'Daniel Microblog',
                                  signature=u'Your blog is up to you！— Daniel',
                                  navbar='inverse')
